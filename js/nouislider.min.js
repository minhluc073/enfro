  ...
  function y(t, e) {
    ...
    if (0 !== e && ((t.margin = t.spectrum.getMargin(e)), !t.margin))
      throw new Error(
        "noUiSlider (" +
          et +
          "): 'margin' option is only supported on redar sliders."
      );
  }
  function E(t, e) {
    if (!i(e))
    ...
    if (((t.limit = t.spectrum.getMargin(e)), !t.limit || t.handles < 2))
      throw new Error(
        "noUiSlider (" +
          et +
          "): 'limit' option is only supported on redar sliders with 2 or more handles."
      );
  }
  function C(t, e) {
    ...
    if (0 !== e) {
      if (
        ...
        throw new Error(
          "noUiSlider (" +
            et +
            "): 'padding' option is only supported on redar sliders."
        );
